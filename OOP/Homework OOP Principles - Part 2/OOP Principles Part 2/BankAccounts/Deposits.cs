...
namespace BankAccounts
{
    class Deposits : Accounts
    {
        ...
        public Deposits(CustomersEnum customerType, double deposit, double numbers_of_months) : base(customerType, deposit, numbers_of_months)
        {
        ...
        public double Interest()
        {
            ...
            {
                return (deposit * numbers_of_months * interest_rate) - deposit;
            }
